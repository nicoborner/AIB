...
$Win10Url = "https://raw.githubusercontent.com/nicoborner/AIB/main/Win10MultiAppsTemplate.json"
...
$installScript = 'https://raw.githubusercontent.com/nicoborner/AIB/main/Install-Applications.ps1'
