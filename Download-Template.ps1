...
$Win10Url = "https://raw.githubusercontent.com/nicoborner/AIB/main/Win10MultiTemplate.json"
...
Install-Module -name 'Az.ImageBuilder' -AllowClobber
...
New-AzVM -ResourceGroupName $imageResourceGroup -Image $ArtifactId -Name myWinVM01 -Credential $Cred -size Standard_D1_v2
